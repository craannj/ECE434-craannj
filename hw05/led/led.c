...
static unsigned int gpioLED = 60;           ///< Default GPIO for the LED is 49
module_param(gpioLED, uint, S_IRUGO);       ///< Param desc. S_IRUGO can be read/not changed
MODULE_PARM_DESC(gpioLED, " GPIO LED 1 number (default=60)");     ///< parameter description
...
MODULE_PARM_DESC(gpioLED, " GPIO LED 2 number (default=50)");     ///< parameter description
...
MODULE_PARM_DESC(blinkPeriod, " LED 1 blink period in ms (min=1, default=1000, max=10000)");
...
MODULE_PARM_DESC(blinkPeriod2, " LED 2 blink period in ms (min=1, default=500, max=10000)");
